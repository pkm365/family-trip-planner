...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "time_slot",
            sa.Enum("MORNING", "AFTERNOON", "EVENING", name="timeslot"),
            nullable=False,
        ),
        sa.Column(
            "category",
        ...
        sa.Column(
            "priority",
            sa.Enum("MUST_DO", "WOULD_LIKE", "OPTIONAL", name="priority"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_activities_trip_id"), "activities", ["trip_id"], unique=False
    )
    op.create_index(
        op.f("ix_activities_activity_date"),
        "activities",
        ["activity_date"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("PARENT", "CHILD", "ADULT", name="memberrole"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_family_members_trip_id"), "family_members", ["trip_id"], unique=False
    )
