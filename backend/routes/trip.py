...
async def update_trip(
    trip_id: int, trip_update: TripUpdate, trip: TripDependency, db: DatabaseSession
) -> TripResponse:
    """
...
def get_trip_daily_activities(trip_id: int, db: DatabaseSession):
    ...
    for activity in activities:
        ...
        slot = (
            activity.time_slot.value
            if hasattr(activity.time_slot, "value")
            else activity.time_slot
        )
        ...
        activity_data = {
            ...
            if hasattr(activity.priority, "value")
            else activity.priority,
        ...
        daily_activities[date_str]["total_estimated_cost"] += (
