...
async def get_combined_weather(
    ...
    current_formatted = weather_service.format_weather_summary(current_data) if current_data else {}
    
    # Extract daily forecasts
    daily_forecasts = weather_service.get_daily_forecasts(forecast_data) if forecast_data else []
