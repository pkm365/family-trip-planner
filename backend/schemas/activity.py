...
class ActivityBase(BaseModel):
    ...
    activity_date: date = Field(
        ...,
        description="Date when activity is planned"
    )
    ...
    actual_cost: Optional[float] = Field(
        None,
        ge=0,
        description="Actual cost spent on this activity"
    )
...
class ActivityCreate(ActivityBase):
    ...
    trip_id: int = Field(
        ...,
        description="ID of the trip this activity belongs to"
    )
...
class ActivityUpdate(BaseModel):
    ...
    category: Optional[ActivityCategory] = Field(
        None,
        description="Activity category"
    )
...
class ActivityResponse(ActivityBase):
    ...
    latitude: Optional[float] = Field(
        ...
        ge=-90,
        le=90,
        description="Activity location latitude"
    )
    ...
    longitude: Optional[float] = Field(
        ...
        ge=-180,
        le=180,
        description="Activity location longitude"
    )
