...
class RecommendationWithVotes(BaseModel):
    ...
    family_votes: List[FamilyMemberVoteInfo] = Field(..., description="Individual family member votes")
    comments: List[ActivityCommentResponse] = Field(..., description="Comments on this recommendation")
...
class VotingDashboardResponse(BaseModel):
    ...
    recommendations_with_votes: List[RecommendationWithVotes] = Field(..., description="Recommendations with vote details")
