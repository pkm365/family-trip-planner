...
class TestTripRoutes:
    ...
    def test_create_trip_success(self, client, sample_trip_data):
        ...
        assert data["accommodation_address"] == sample_trip_data["accommodation_address"]
    ...
    def test_get_trip_weather_success(self, client, sample_trip, mock_weather_service):
        ...
        with pytest.mock.patch('backend.services.trip_service.weather_service', mock_weather_service):
    ...
    def test_get_trip_family_preferences(self, client, sample_trip, sample_family_member):
